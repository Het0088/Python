...
def TaskExe():
    ...
    def Music():
        ...
        if 'beat' in musicName:
            os.startfile('G:\\jarvis\\beat 9.mp3')

        elif 'future' in musicName:
            os.startfile('G:\\JarvisAI\\the-future-bass-15017.mp3')
    ...
    def OpenApps():
        ...
        if 'code' in query:
            ...
            os.startfile("C:\\Program Files\\Grand Theft Auto V\\Run_GTAV.exe")

        elif 'opera' in query:
            os.startfile("C:\\Users\\hetpa\\AppData\\Local\\Programs\\Opera GX\\launcher.exe")
            ...
            webbrowser.open('https://www.google.com/maps/@22.3203159,73.2194678,20z')
    ...
    def Reader():
        ...
        if 'science' in name:
            ...
            os.startfile('G:\\PC\\science ch-4.pdf')
            book = open('G:\\PC\\science ch-4.pdf','rb')
            ...
            os.startfile('G:\\PC\\ss ch-4.pdf')
            book = open('G:\\PC\\ss ch-4.pdf','rb')
            pdfreader = PyPDF2.PdfFileReader(book)
            pages = pdfreader.getNumPages()
            Speak(f"Number Of Pages In This Books Are {pages}")
            Speak("From Which Page I Have To Start Reading ?")
    ...
    def Tran():
        ...
        Text = result.text
        Speak("The translation for the line is" + Text)
